...
<div style="max-width: 1000px; margin: 0 auto;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 32px;">
        <div>
            <h1 style="margin: 0; font-size: 28px; font-weight: 700; color: var(--efficio-text);">Nuova Identità Aziendale</h1>
            <p style="margin: 8px 0 0 0; color: var(--efficio-muted); font-size: 16px;">Configura l'identità visiva e i brand della tua azienda</p>
        </div>
    ...
    <form method="POST" action="{{ route('company-identity.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div style="padding: 24px; border-bottom: var(--border);">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        ...
                        <input type="text" id="company_name" name="company_name" value="{{ old('company_name') }}" class="form-input" required>
                        @error('company_name')
                    ...
                    <div>
                        ...
                        <input type="text" id="commercial_name" name="commercial_name" value="{{ old('commercial_name') }}" class="form-input">
                    ...
                    <div>
                        ...
                        <input type="text" id="slogan" name="slogan" value="{{ old('slogan') }}" class="form-input">
                        @error('slogan')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" id="website" name="website" value="{{ old('website') }}" class="form-input" placeholder="https://www.esempio.it">
                        @error('website')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div style="padding: 24px; border-bottom: var(--border);">
                ...
                <div style="display: grid; gap: 20px;">
                    <div>
                        ...
                        <textarea id="mission" name="mission" rows="3" class="form-input" placeholder="Descrivi la missione della tua azienda...">{{ old('mission') }}</textarea>
                        @error('mission')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="vision" name="vision" rows="3" class="form-input" placeholder="Descrivi la visione della tua azienda...">{{ old('vision') }}</textarea>
                        @error('vision')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="values" name="values" rows="3" class="form-input" placeholder="Inserisci i valori aziendali separati da virgole...">{{ old('values') }}</textarea>
            ...
            <div style="padding: 24px; border-bottom: var(--border);">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        ...
                        <input type="text" id="partita_iva" name="partita_iva" value="{{ old('partita_iva') }}" class="form-input">
                        @error('partita_iva')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="codice_fiscale" name="codice_fiscale" value="{{ old('codice_fiscale') }}" class="form-input">
                    ...
                    <div>
                        ...
                        <input type="text" id="rea" name="rea" value="{{ old('rea') }}" class="form-input">
                        @error('rea')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="pec" name="pec" value="{{ old('pec') }}" class="form-input">
                        @error('pec')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="sdi" name="sdi" value="{{ old('sdi') }}" class="form-input">
                        @error('sdi')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div style="margin-top: 20px;">
                    ...
                    <textarea id="legal_address" name="legal_address" rows="3" class="form-input" placeholder="Via, numero, CAP, città, provincia...">{{ old('legal_address') }}</textarea>
                    @error('legal_address')
                        <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <input type="color" id="primary_color" name="primary_color" value="{{ old('primary_color', '#6366f1') }}" style="width: 50px; height: 40px; border: none; border-radius: 8px; cursor: pointer;">
                            <input type="text" value="{{ old('primary_color', '#6366f1') }}" class="form-input" style="flex: 1;" readonly>
                        </div>
                        @error('primary_color')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    ...
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <input type="color" id="secondary_color" name="secondary_color" value="{{ old('secondary_color', '#8b5cf6') }}" style="width: 50px; height: 40px; border: none; border-radius: 8px; cursor: pointer;">
                            <input type="text" value="{{ old('secondary_color', '#8b5cf6') }}" class="form-input" style="flex: 1;" readonly>
                        </div>
                    ...
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <input type="color" id="neutral_color" name="neutral_color" value="{{ old('neutral_color', '#6b7280') }}" style="width: 50px; height: 40px; border: none; border-radius: 8px; cursor: pointer;">
                            <input type="text" value="{{ old('neutral_color', '#6b7280') }}" class="form-input" style="flex: 1;" readonly>
                        </div>
                        @error('neutral_color')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    ...
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <input type="color" id="success_color" name="success_color" value="{{ old('success_color', '#10b981') }}" style="width: 50px; height: 40px; border: none; border-radius: 8px; cursor: pointer;">
                            <input type="text" value="{{ old('success_color', '#10b981') }}" class="form-input" style="flex: 1;" readonly>
                        </div>
                        @error('success_color')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    ...
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <input type="color" id="error_color" name="error_color" value="{{ old('error_color', '#ef4444') }}" style="width: 50px; height: 40px; border: none; border-radius: 8px; cursor: pointer;">
                            <input type="text" value="{{ old('error_color', '#ef4444') }}" class="form-input" style="flex: 1;" readonly>
                        </div>
                        @error('error_color')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        ...
                        <select id="primary_font" name="primary_font" class="form-select">
                            <option value="Inter" {{ old('primary_font') == 'Inter' ? 'selected' : '' }}>Inter</option>
                            <option value="Roboto" {{ old('primary_font') == 'Roboto' ? 'selected' : '' }}>Roboto</option>
                            <option value="Open Sans" {{ old('primary_font') == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                            <option value="Lato" {{ old('primary_font') == 'Lato' ? 'selected' : '' }}>Lato</option>
                            <option value="Poppins" {{ old('primary_font') == 'Poppins' ? 'selected' : '' }}>Poppins</option>
                            <option value="system-ui" {{ old('primary_font') == 'system-ui' ? 'selected' : '' }}>System UI</option>
                        </select>
                        @error('primary_font')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="secondary_font" name="secondary_font" class="form-select">
                            <option value="system-ui" {{ old('secondary_font') == 'system-ui' ? 'selected' : '' }}>System UI</option>
                            <option value="Georgia" {{ old('secondary_font') == 'Georgia' ? 'selected' : '' }}>Georgia</option>
                            <option value="Times New Roman" {{ old('secondary_font') == 'Times New Roman' ? 'selected' : '' }}>Times New Roman</option>
                            <option value="serif" {{ old('secondary_font') == 'serif' ? 'selected' : '' }}>Serif</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="style_type" name="style_type" class="form-select">
                            <option value="corporate" {{ old('style_type') == 'corporate' ? 'selected' : '' }}>Corporate</option>
                            <option value="creative" {{ old('style_type') == 'creative' ? 'selected' : '' }}>Creativo</option>
                            <option value="minimal" {{ old('style_type') == 'minimal' ? 'selected' : '' }}>Minimal</option>
                            <option value="modern" {{ old('style_type') == 'modern' ? 'selected' : '' }}>Moderno</option>
                        </select>
                        @error('style_type')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
            ...
            <div style="padding: 24px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        ...
                        <input type="text" id="branch_code" name="branch_code" value="{{ old('branch_code') }}" class="form-input" placeholder="Es: RM, MI, TO">
                    ...
                    <div>
                        ...
                        <input type="text" id="branch_name" name="branch_name" value="{{ old('branch_name') }}" class="form-input" placeholder="Es: Roma, Milano, Torino">
                        @error('branch_name')
                            <div style="color: #f87171; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div style="display: flex; gap: 16px; justify-content: flex-end; padding: 24px 0;">
            <a href="{{ route('company-identity.index') }}" class="btn-secondary">
                Annulla
            </a>
